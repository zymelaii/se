...
#define SyntaxError            0x01 // 语法错误
#define TypeError              0x02 // 类型错误
#define IndexError             0x03 // 数组索引错误
#define RuntimeError           0x04 // 运行时错误
#define CustomError            0x05 // 自定义错误类型（起始值）
...
#define ModuloWithFloat        0x05 // 对浮点数组进行取模
...
// RuntimeError
#define ExpectFunctionName     0x01 // 缺少函数调用名
...
#define MathOperationWithInf   0x07 // Inf值参与数学运算
